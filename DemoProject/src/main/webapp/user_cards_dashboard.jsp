...
%>
  ...
  <div class="sidebar" style="margin-top:60px;">
    ...
    <a href="FundamentalDisplay"><i class="fa-solid fa-id-card"></i><span>Acts</span></a>
 ...
 <input type="checkbox" id="check">
  ...
  <div class="sidebar" style="margin-top:60px;">
    <div align="center">
	    ...
	    <a href="fundamental_display.jsp"><i class="fa-solid fa-id-card"></i><span>Display Acts</span></a>
	    <a href="LogoutServlet"><i class="glyphicon glyphicon-log-out"></i><span>Log out</span></a>
	  </div>
  <div class="content">
    <div align="center">
