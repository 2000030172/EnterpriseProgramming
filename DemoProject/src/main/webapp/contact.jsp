...
<body>
    ...
    <br>
<div id="id1">
    <form method="post" action="ControlController">        
        <div class="container"> 
            <h1>Contact Us</h1>
              ...
              <div class="input-field">
               ...
               <div class="input-field">
                   ...
                   <input type="text" placeholder="Subject" name="csub" required/>                   
               </div>
               <div class="input-field">
               <i class="fa-solid fa-message"></i>
                   <input type="text" placeholder="Message" class="form-control" name="cmsg" />
               </div>
