        ...
        <div class="container"> 
            <h1>Profile</h1>
              ...
              <div class="input-field">
                   ...
                   <input type="text" placeholder="Username"  name="user" value=<%= username  %> disabled/>
               </div><div class="input-field">
                    <i class="fa-solid fa-envelope"></i>
                   <input type="text" placeholder="Email"  name="pemail" value=<%= email  %> disabled>
              </div>
               <div class="input-field">
                   <i class="fas fa-user"></i>
                   <input type="text" placeholder="Name" name="name" value=<%= name  %> disabled/>
               </div>
               <div class="input-field">
